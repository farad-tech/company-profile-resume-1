        ...
        <div class="row gx-5">
            <div class="col-lg-4 text-center py-3">
                <div class="d-inline-flex align-items-center">
                    ...
                    <div class="text-start">
                        <p class="text-uppercase fw-bold">Our Office</p>
            ...
            <div class="col-lg-4 text-center border-start border-end py-3">
                <div class="d-inline-flex align-items-center">
                    ...
                    <div class="text-start">
                        <p class="text-uppercase fw-bold">Email Us</p>
                        <span><a href="mailto:info@example.com">Send Email</a></span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 text-center py-3">
                <div class="d-inline-flex align-items-center">
                    ...
                    <div class="text-start">
                        <p class="text-uppercase fw-bold">Call Us</p>
    ...
    <div class="container-fluid sticky-top bg-dark bg-light-radial shadow-sm px-5 pe-lg-0">
        <nav class="navbar navbar-expand-lg bg-dark bg-light-radial navbar-dark py-3 py-lg-0">
            <a href="index.html" class="navbar-brand">
                <h3 class="m-0 display-4 text-uppercase text-white"><i class="bi bi-building text-primary me-2"></i>WEBUILD
                </h3>
            </a>
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <p class="display-2 text-uppercase text-white mb-md-4">Build Your Dream House With Us</p>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <p class="display-2 text-uppercase text-white mb-md-4">We Are Trusted For Your Project</p>
